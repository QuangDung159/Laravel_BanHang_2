                        ...
                        <li data-transition="boxfade" data-slotamount="20" class="active-revslide"
                            ...
                            <div class="slotholder" style="width:100%;height:100%;" data-duration="undefined"
                                ...
                                <div class="tp-bgimg defaultimg" data-lazyload="undefined" data-bgfit="cover"
                                     ...
                                     src="{{asset('assets/images/thumbs/1.jpg')}}" data-src="{{asset('assets/images/thumbs/1.jpg')}}'"
                                     style="background-color: rgba(0, 0, 0, 0); background-repeat: no-repeat; background-image: url('assets/images/thumbs/1.jpg'); background-size: cover; background-position: center center; width: 100%; height: 100%; opacity: 1; visibility: inherit;">
                                </div>
                            </div>
ß
                        </li>
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <div class="single-item">
                                    <div class="single-item-header">
                                        <a href="product.html"><img src="{{asset('assets/images/products/1.jpg')}}" alt=""></a>
                                    </div>
                            ...
                            <div class="col-sm-3">
                                <div class="single-item">
                                    ...
                                    <div class="single-item-header">
                                        <a href="product.html"><img src="{{asset('assets/images/products/2.jpg')}}" alt=""></a>
                                    </div>
                                    <div class="single-item-body">
                                        <p class="single-item-title">Sample Woman Top</p>
                                        <p class="single-item-price">
                            ...
                            <div class="col-sm-3">
                                <div class="single-item">
                                    <div class="single-item-header">
                                        <a href="product.html"><img src="{{asset('assets/images/products/3.jpg')}}" alt=""></a>
                                    </div>
                                    <div class="single-item-body">
                                        <p class="single-item-title">Sample Woman Top</p>
                                        <p class="single-item-price">
